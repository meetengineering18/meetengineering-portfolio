...
const Hero = () => {
  ...
  return (
    <section className="relative overflow-hidden pt-10 w-full h-full"> 
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 w-full h-full">
          ...
          <div className="flex flex-col space-y-5 justify-center h-full animate-slideInFromLeft">
            <div>
              ...
              <p className="mt-4 text-xl font-semibold uppercase tracking-wider text-gray-700">
                MFG. OF PRECISION ENGINEERING PARTS OF STEEL METAL
              </p>
            </div>

            <p className="text-gray-600 text-2xl max-w-lg">
            ...
            <div className="flex flex-wrap gap-4 pt-4">
              <button
                ...
                className="relative inline-flex h-14 w-auto overflow-hidden rounded-full p-[3px] focus:outline-none focus:ring focus:ring-slate-400 focus:ring-offset-4 focus:ring-offset-slate-50"
              >
  ...
  <span className="relative inline-flex h-full w-full items-center justify-center rounded-full bg-slate-950/90 px-6 py-2 text-base font-medium text-white backdrop-blur-xl">
    Our Services 
              ...
              <Link href="/contact">
                <button className="shadow-[0_0_0_0.5px_#000000_inset] px-6 py-2 bg-transparent border border-gray-900 text-gray-900 rounded-lg font-bold transform hover:-translate-y-1 transition duration-400">
                  Get Quote
                </button>
              </Link>
            </div>
